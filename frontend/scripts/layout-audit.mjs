...
const PUBLIC = ['forgotpw', 'rxverify', 'verified', 'checkemail', 'home', 'search', 'profile', 'pinfo', 'confirm', 'about', 'forpatients', 'fordoctors', 'contact', 'plogin', 'pregister', 'login', 'docregister', 'confidentialite', 'paccount', 'pmessages'];
