...
const SCREENS = [
  ...
  'dnotif', 'dstats', 'dabo', 'dsettings', 'dchat', 'dshare', 'dprescribe', 'dstaff', 'dtasks', 'dpfile', 'dbill', 'dplans', 'dstations', 'dsila',
];
...
try {
  ...
  // congés conflict detection — "Disponibilités" lives in the « Paramètres » group rail
